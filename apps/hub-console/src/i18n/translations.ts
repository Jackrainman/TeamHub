...
const zh = {
  ...
  // 集成（INTEGRATIONS-TO-SETTINGS）：适配器→集成、归设置页只读子节
  'settings.section.integrations': '集成',
  'settings.integrations.desc': '飞书 / Hermes / Git 等外部应用的对接状态，只读。真实接入仍在搭，目前是占位演示。',
  'settings.integrations.unavailable': '集成状态读不到（后端没连上？）。',
  'settings.integrations.empty': '还没登记任何集成。',
  'overview.integrations.toSettings': '集成对接状态（飞书 / Hermes / Git）已移到设置页 →',
...
const en: Record<TranslationKey, string> = {
  ...
  'settings.integrations.desc':
    'Connection status of external apps (Feishu / Hermes / Git), read-only. Real wiring is still being built; shown here as a placeholder.',
  'settings.integrations.unavailable': 'Integration status unavailable (backend not connected?).',
  'settings.integrations.empty': 'No integrations registered yet.',
  'overview.integrations.toSettings': 'Integration status (Feishu / Hermes / Git) moved to Settings →',
