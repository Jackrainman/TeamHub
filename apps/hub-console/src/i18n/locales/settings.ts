export const zhSettings = {
  ...
  'settings.theme.notionDark': 'Notion 夜航',
  'settings.theme.linear': 'Linear 风',
  ...
  'settings.export.govReport.desc': '项目级汇报（里程碑进度/任务完成/在场统计/库存消耗）：HTML 浏览器打开后打印即存 PDF，Markdown 便于粘贴改写。',
  'settings.export.govReport.html': '导出项目汇报（HTML·可打印 PDF）',
  'settings.export.govReport.md': '导出项目汇报（Markdown）',
  ...
  'settings.members.resetPin': '重置密码',
  'settings.members.resetPin.confirm':
    '确定重置 {name} 的密码？重置后旧密码立即失效，该成员下次登录后须先重设密码。',
  'settings.members.resetPin.done': '已重置。该成员下次登录后须先设置新密码。',
  'settings.members.resetPin.error': '重置失败：{detail}',
  'settings.members.setup.title': '初始化管理员',
  'settings.members.setup.desc':
    '本队还没有项目管理成员。设一个密码，给当前登录的你授项目管理旗标——此后授旗/收旗、建赛季等敏感设置都需要管理员身份。',
  'settings.members.setup.pinLabel': '管理员密码',
  'settings.members.setup.pinPlaceholder': '至少 8 位',
...
export const enSettings = {
  ...
  'settings.theme.notionDark': 'Notion dark',
  ...
  'settings.export.govReport.desc': 'Project-level report (milestones / tasks / presence / inventory): open the HTML and print to save as PDF; Markdown for easy editing.',
  'settings.export.govReport.html': 'Export project report (HTML · printable PDF)',
  'settings.export.govReport.md': 'Export project report (Markdown)',
  ...
  'settings.members.resetPin': 'Reset password',
  'settings.members.resetPin.confirm':
    'Reset password for {name}? The old password stops working immediately; they must set a new one on next login.',
  'settings.members.resetPin.done':
    'Password reset. They must set a new password on next login.',
  'settings.members.resetPin.error': 'Reset failed: {detail}',
  'settings.members.setup.title': 'Set up admin',
  'settings.members.setup.desc':
    'This team has no project-management member yet. Set a password to grant the currently logged-in you the project-management flag — after that, sensitive settings like granting flags or creating seasons require admin rights.',
  'settings.members.setup.pinLabel': 'Admin password',
  'settings.members.setup.pinPlaceholder': 'At least 8 characters',
