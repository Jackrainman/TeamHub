export const zhInv = {
  ...
  'inv.record.field.acquisition': '来源（仅补料）',
  'inv.acquisition.selfPurchase': '自购',
  'inv.acquisition.sponsored': '赞助',
...
export const enInv = {
  ...
  'inv.record.field.acquisition': 'Source (restock only)',
  'inv.acquisition.selfPurchase': 'Self-purchased',
  'inv.acquisition.sponsored': 'Sponsored',
