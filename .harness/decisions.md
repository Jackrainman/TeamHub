...
- **②替换为访问不变式**：凭证附件是**条目级私有事实**——只对提交本人与承担财务职责的成员可读（沿用现有 authz 口，是否为「财务」单独立权限旗在 REIMBURSE-EVIDENCE-STORE 立项时定），永不进列表、聚合、统计或任何无鉴权静态路径，下载留操作者痕迹。I0 不受影响：附件回指本人，第三方只见结构键。
