...
export const ARCHITECTURE_BASELINE = Object.freeze([
  ...
  ['legacy-file-store', 'apps/hub-server/src/store/file-inv-store.ts', 1],
  ['legacy-file-store', 'apps/hub-server/src/store/file-kb-store.ts', 1],
  ['legacy-file-store', 'apps/hub-server/src/store/file-reimburse-store.ts', 1],
  ['legacy-persisted-file', 'apps/hub-server/src/store/file-baseline-store.ts', 1],
  ['legacy-persisted-file', 'apps/hub-server/src/store/file-checklist-store.ts', 1],
  ['legacy-persisted-file', 'apps/hub-server/src/store/file-gov-store.ts', 1],
  ['legacy-persisted-file', 'apps/hub-server/src/store/file-inv-store.ts', 1],
  ['legacy-persisted-file', 'apps/hub-server/src/store/file-kb-store.ts', 1],
  ['legacy-persisted-file', 'apps/hub-server/src/store/file-reimburse-store.ts', 1],
  ['legacy-persisted-file', 'apps/hub-server/src/store/persisted-file.ts', 1],
  ...
  ['production-inmemory-fallback', 'apps/hub-server/src/store/file-inv-store.ts', 2],
  ['production-inmemory-fallback', 'apps/hub-server/src/store/file-reimburse-store.ts', 2],
