...
current_task: null  # base 收口刀已 commit+push(frontier#1 done)；下一可认领 frontier#1 = KB-CORE-DESIGN，按 §6 双轨选（Claude Code 走 §6.B continuous-build / 弱工具走 §6.A atomic-task）
