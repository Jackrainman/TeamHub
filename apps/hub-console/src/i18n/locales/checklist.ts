export const zhChecklist = {
  ...
  'gate.subtitle':
    '登录制已开启，但名册里还没有项目管理成员。七步完成初始化——先说你是谁，再导名册、认组长、建赛季、录库存、导排障档案。',
  'gate.step.who': '① 你是谁',
...
export const enChecklist = {
  ...
  'gate.subtitle':
    'Login mode is on, but no project-management member exists yet. Seven steps: say who you are, import the roster, confirm group leads, create the season, load the inventory, import the knowledge base.',
