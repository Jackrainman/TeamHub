export const zhPm = {
  ...
  'timeline.offset.plus1d': '+1天',
  'timeline.offset.plus3d': '+3天',
  'timeline.offset.plus1w': '+1周',
  'timeline.offset.plus2w': '+2周',
  'timeline.offset.today': '今天完成',
  'timeline.offset.minus3d': '-3天',
  'timeline.offset.minus1w': '-1周',
  'timeline.preview.date': '预览：{date}',
  'timeline.preview.pace': '每周需推进 {perWeek} 个',
  'timeline.preview.overrun': '⚠ 越过比赛日',
  'timeline.segments.title': '低频调整：时间段边界',
  'timeline.segments.note': '时间段是赛季骨架，改动会影响所有里程碑落位，谨慎调整。',
  'timeline.segments.start': '开始',
  'timeline.segments.end': '结束',
  'timeline.segments.apply': '保存该段',
...
export const enPm = {
  ...
  'timeline.offset.plus1d': '+1d',
  'timeline.offset.plus3d': '+3d',
  'timeline.offset.plus1w': '+1w',
  'timeline.offset.plus2w': '+2w',
  'timeline.offset.today': 'Done today',
  'timeline.offset.minus3d': '-3d',
  'timeline.offset.minus1w': '-1w',
  'timeline.preview.date': 'Preview: {date}',
  'timeline.preview.pace': '{perWeek}/week needed',
  'timeline.preview.overrun': '⚠ past competition date',
  'timeline.segments.title': 'Low-frequency: segment boundaries',
  'timeline.segments.note': 'Segments are the season skeleton — changing them shifts every milestone. Adjust with care.',
  'timeline.segments.start': 'Start',
  'timeline.segments.end': 'End',
  'timeline.segments.apply': 'Save segment',
