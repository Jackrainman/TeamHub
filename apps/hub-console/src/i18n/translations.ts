...
const zh = {
  ...
  // 设置页「验收人名单」分区
  'settings.section.reviewers': '验收人名单',
  'settings.reviewers.desc': '豁免权属名单内成员（大三），每年换届更新。名单只决定谁能签字豁免欠条。',
  'settings.reviewers.empty': '暂无成员。',
  ...
  'pool.action.reviewerOnly': '验收权属验收人名单（大三）。',
...
const en: Record<TranslationKey, string> = {
  ...
  'settings.section.reviewers': 'Reviewer roster',
  'settings.reviewers.desc': 'Waiving is restricted to roster members (juniors), refreshed each handover. The roster only decides who may sign off a waiver.',
  'settings.reviewers.empty': 'No members yet.',
  ...
  'pool.action.reviewerOnly': 'Reviewing is restricted to the reviewer roster (juniors).',
